...
- **Beveiligingsproblemen hierboven** — wachten op Brents beslissing.
- **Volledige bug-audit uitgevoerd (2026-07-25)** — volledig rapport in [`docs/reviews/bug-audit-2026-07-25.md`](docs/reviews/bug-audit-2026-07-25.md). Uitvoeringsplan (25 taken in 6 fases, herprioriteerd t.o.v. het audit-rapport voor efficiëntie op lange termijn) staat in [`docs/superpowers/plans/2026-07-25-bug-fix-roadmap.md`](docs/superpowers/plans/2026-07-25-bug-fix-roadmap.md). Nog niets van uitgevoerd, wachten op Brents goedkeuring om te starten. Kritiekste bevindingen (nieuw t.o.v. de beveiligingsproblemen hierboven):
